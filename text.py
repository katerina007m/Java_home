...
fields_rename_contact = ['Введите новое имя контакта (или Enter - без именений): ',
                         'Введите новый телефон (или Enter - без именений): ',
                         'Введите новый комментарий (или Enter - без именений): ']
